...
if __name__ == "__main__":
    ...
    # results = run_pipeline(site_df, K=2)
    ...
    sites = rng.choice(["S1","S2","S3","S4","S5"], size=n)
    basin_map = {"S1": 120, "S2": 340, "S3": 85, "S4": 210, "S5": 500}
 
    site_df = make_multi_site_df(get_site_ids())
    results = run_pipeline(site_df, K=2)
